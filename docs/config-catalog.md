...
Source: [`packages/credentials/credentials-local/src/index.ts:47`](../packages/credentials/credentials-local/src/index.ts)
...
Source: [`packages/llm/llm-provider/src/index.ts:185`](../packages/llm/llm-provider/src/index.ts)
...
Source: [`packages/mcp/mcp-keyring/src/index.ts:41`](../packages/mcp/mcp-keyring/src/index.ts)
...
Source: [`packages/ptc-runtime/ptc-runtime-node/src/index.ts:50`](../packages/ptc-runtime/ptc-runtime-node/src/index.ts)
...
Source: [`packages/session/session-persistence-jsonl/src/index.ts:99`](../packages/session/session-persistence-jsonl/src/index.ts)
...
Source: [`packages/tools/tool-mineru/src/index.ts:35`](../packages/tools/tool-mineru/src/index.ts)
...
Source: [`packages/web/web-search-anysearch/src/index.ts:39`](../packages/web/web-search-anysearch/src/index.ts)
...
Source: [`packages/web/web-search-exa/src/index.ts:34`](../packages/web/web-search-exa/src/index.ts)
...
Source: [`packages/web/web-search-perplexity/src/index.ts:29`](../packages/web/web-search-perplexity/src/index.ts)
...
- `@deepseek-ai/dsh-skill-baidu-netdisk` — requires `skills` ([`packages/skill/skill-baidu-netdisk/src/index.ts`](../packages/skill/skill-baidu-netdisk/src/index.ts))
