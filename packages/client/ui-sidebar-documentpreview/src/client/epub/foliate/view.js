// Vendored from johnfactotum/foliate-js (upstream snapshot, see foliate-js-LICENSE).
// Local modifications: dropped the makeBook/file-format machinery and the
// paginator/fixed-layout dynamic imports (this host always hands `open()` an
// initialized EPUB instance and needs every module in the static graph).
...
typeof customElements !== 'undefined' && customElements.define('foliate-view', View)
