...
export const en = {
  ...
  inputText: 'Text',
  inputReasoning: 'Reasoning',
  inputImage: 'Images',
  inputVideo: 'Video',
  inputFile: 'Files',
  inputTypesHint: 'Text is always on. Unticked types that the row does not declare keep the provider’s own declaration.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  inputVideo: '视频',
  inputFile: '文件',
  inputTypesHint: '文本恒为必选；未勾选且该行未声明的类型，沿用提供方自身的声明。',
  fetchModels: '获取可用模型',
  fetching: '正在询问提供方\u2026',
