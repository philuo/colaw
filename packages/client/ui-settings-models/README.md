...
- **Only pi-ai routes can be hand-declared** — the custom-provider card writes into `llm-provider`, the one namespace whose profiles describe a whole provider. A `llm-deepseek` route is a composition fact, not something this page can create.
