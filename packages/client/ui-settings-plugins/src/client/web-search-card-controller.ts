...
/** The search-provider fields this card edits. The key is the only one:
 * the endpoint is the product's own AnySearch MCP and is not a reader-facing
 * setting. */
export interface WebSearchSettings {
  /** Credential reference naming the stored key. */
  apiKeyEnv?: string
}
