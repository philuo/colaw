...
export type PluginsSettingsLocaleKey =
  ...
  | 'webSearchApiKeyStored' | 'webSearchApiKeyPlaceholder'
...
export const en: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchDescription: 'Search with the built-in AnySearch MCP tool.',
  webSearchApiKey: 'API key',
  webSearchApiKeyHint: 'Leave blank to keep the current key.',
  ...
  'builtin.qccHint': 'Leave blank to keep the current key.',
  ...
  'builtin.firecrawlHint': 'Leave blank to keep the current key.',
  ...
  'builtin.mineruHint': 'Leave blank to keep the current key.',
...
export const zh: Record<PluginsSettingsLocaleKey, string> = {
  ...
  webSearchTitle: '网页搜索',
  webSearchDescription: '使用 AnySearch 搜索',
  webSearchApiKey: 'API Key',
  webSearchApiKeyHint: '留空表示保持当前密钥。',
