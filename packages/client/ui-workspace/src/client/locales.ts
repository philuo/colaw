...
export const zh = {
  ...
  'trash.nav': '回收站',
  'trash.title': '回收站',
  'trash.intro': '注意删除后无法找回会话',
  'trash.empty': '回收站是空的',
  'trash.loading': '正在载入…',
  'trash.archivedAt': '归档于',
  'trash.archivedUnknown': '归档时间未记录',
  'trash.restore': '恢复会话',
  'trash.restoreTip': '恢复会话',
  'trash.deleteTip': '删除会话',
  'trash.delete': '删除',
  'trash.back': '返回列表',
  'trash.clear': '清空全部',
  'trash.cancel': '取消',
  'trash.confirm': '永久删除',
  'trash.confirmClearTitle': '清空回收站？',
  'trash.confirmClearBody': '将永久删除全部 {n} 个会话，无法找回。',
  'trash.previewNone': '点击会话查看内容',
  'trash.previewEmpty': '（无可预览的对话内容）',
  'trash.copy': '复制',
  'trash.copied': '已复制',
  'trash.footnotes': '脚注',
  'trash.locale': 'zh',
...
export const en = {
  ...
  'menu.noWorkspace': 'Without workspace',
  ...
  'trash.nav': 'Trash',
  'trash.title': 'Trash',
  'trash.intro': 'Sessions cannot be recovered once deleted',
  'trash.empty': 'Trash is empty',
  'trash.loading': 'Loading…',
  'trash.archivedAt': 'Archived',
  'trash.archivedUnknown': 'Archive time not recorded',
  'trash.restore': 'Restore session',
  'trash.restoreTip': 'Restore session',
  'trash.deleteTip': 'Delete session',
  'trash.delete': 'Delete',
  'trash.back': 'Back to list',
  'trash.clear': 'Empty all',
  'trash.cancel': 'Cancel',
  'trash.confirm': 'Delete forever',
  'trash.confirmClearTitle': 'Empty the trash?',
  'trash.confirmClearBody': 'All {n} sessions will be deleted forever and cannot be recovered.',
  'trash.previewNone': 'Open a session to preview it',
  'trash.previewEmpty': '(No previewable conversation content)',
  'trash.copy': 'Copy',
  'trash.copied': 'Copied',
  'trash.footnotes': 'Footnotes',
  'trash.locale': 'en',
