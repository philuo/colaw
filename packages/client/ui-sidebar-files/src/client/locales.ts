...
export const zh = {
  ...
  'search.clear': '清除搜索',
  'search.noMatches': '没有匹配的文件或目录。',
  'search.failed': '搜索失败。',
  'search.more': '匹配项较多，仅显示前 {n} 条，请细化关键词。',
...
export const en = {
  ...
  'search.placeholder': 'Search files or folders…',
  'search.clear': 'Clear search',
  'search.noMatches': 'No matching files or folders.',
  'search.failed': 'Search failed.',
  'search.more': 'More than {n} matches; refine the keyword to narrow it down.',
