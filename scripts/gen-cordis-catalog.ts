...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  __placeholder__: 'internal placeholder Context key (typed unknown) used to anchor a client face merge — packages/client/ui-sidebar-files/README.md owns the API',
}
...
export const EVENT_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  'connection/request': 'client-face HTTP request waterfall — packages/client/connection/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  WorkspaceTreeSearchFrame: 'Host workspace tree-search frame contract is owned by packages/api/workspace-files/README.md',
  WorkspaceTrashValue: 'fork recycle-bin value contract is owned by packages/api/workspace-controller/README.md',
  WorkspaceDeleteSessionRequest: 'fork recycle-bin delete request contract is owned by packages/api/workspace-controller/README.md',
